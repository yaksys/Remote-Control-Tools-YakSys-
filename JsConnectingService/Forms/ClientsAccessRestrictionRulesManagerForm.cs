...
public class ClientsAccessRestrictionRulesManagerForm : System.Windows.Forms.Form
{
    ...
    void ChangeControlsLanguage()
    {
        ...
        this.button_AccessRestrictionRulesManager_Add.Text = ServerStringFactory.GetString(23, MainForm.CurrentLanguage);
        this.button_AccessRestrictionRulesManager_Apply.Text = ServerStringFactory.GetString(79, MainForm.CurrentLanguage);
        this.button_AccessRestrictionRulesManager_Cancel.Text = ServerStringFactory.GetString(86, MainForm.CurrentLanguage);

        this.radioButton_AccessRestrictionRulesManager_RestrictByIPRange.Text = ServerStringFactory.GetString(189, MainForm.CurrentLanguage);
        this.radioButton_AccessRestrictionRulesManager_RestrictByIPAddress.Text = ServerStringFactory.GetString(190, MainForm.CurrentLanguage);
        this.radioButton_AccessRestrictionRulesManager_RestrictByMACAddress.Text = ServerStringFactory.GetString(191, MainForm.CurrentLanguage);

        this.label_AccessRestrictionRulesManager_IPRangeStartValue.Text = ServerStringFactory.GetString(192, MainForm.CurrentLanguage);
        this.label_AccessRestrictionRulesManager_IPRangeEndValue.Text = ServerStringFactory.GetString(193, MainForm.CurrentLanguage);

        this.label_AccessRestrictionRulesManager_IPAddress.Text = ServerStringFactory.GetString(185, MainForm.CurrentLanguage);

        this.label_AccessRestrictionRulesManager_MACAddress.Text = ServerStringFactory.GetString(186, MainForm.CurrentLanguage);

        this.label_AccessRestrictionRulesManager_RuleType.Text = ServerStringFactory.GetString(196, MainForm.CurrentLanguage);

        this.checkBox_AccessRestrictionRulesManager_AddMACAdressToRule.Text = ServerStringFactory.GetString(194, MainForm.CurrentLanguage);
        ...
        this.groupBox_AccessRestrictionRulesManager_IPRange.Text = ServerStringFactory.GetString(227, MainForm.CurrentLanguage);
    }
    ...
    private void button_AccessRestrictionRulesManager_Add_Click(object sender, System.EventArgs e)
    {
          ...
          )
        {
            ...
            ConnectingServiceLogsEvents.NewClientsLogRecordEvent(ServerStringFactory.GetString(44, MainForm.CurrentLanguage), DateTime.Now.ToShortDateString(), DateTime.Now.ToLongTimeString(), "", "", ServerStringFactory.GetString(1, MainForm.CurrentLanguage), ServerStringFactory.GetString(214, MainForm.CurrentLanguage), false);
