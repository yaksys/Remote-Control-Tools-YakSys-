    ...
    public static class Direct3DCapture
    {
        ...
        public static Bitmap CaptureRegionDirect3D(IntPtr handle, Rectangle region)
        {
            ...
            else
            {
                ...
                device = new SlimDX.Direct3D9.Device(_direct3D9, adapterInfo.Adapter, SlimDX.Direct3D9.DeviceType.Hardware, hWnd, SlimDX.Direct3D9.CreateFlags.HardwareVertexProcessing, parameters);
