...
public class AccessRestrictionRulesManagerForm : System.Windows.Forms.Form
{
	...
	{
		this.Text = ServerStringFactory.GetString(195, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage);

		this.button_AccessRestrictionRulesManager_Add.Text = ServerStringFactory.GetString(23, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
		this.button_AccessRestrictionRulesManager_Apply.Text = ServerStringFactory.GetString(79, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
		this.button_AccessRestrictionRulesManager_Cancel.Text = ServerStringFactory.GetString(86, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
	
		this.radioButton_AccessRestrictionRulesManager_RestrictByIPRange.Text = ServerStringFactory.GetString(189, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
		this.radioButton_AccessRestrictionRulesManager_RestrictByIPAddress.Text = ServerStringFactory.GetString(190, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
		this.radioButton_AccessRestrictionRulesManager_RestrictByMACAddress.Text = ServerStringFactory.GetString(191, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
	
		this.label_AccessRestrictionRulesManager_IPRangeStartValue.Text = ServerStringFactory.GetString(192, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
		this.label_AccessRestrictionRulesManager_IPRangeEndValue.Text = ServerStringFactory.GetString(193, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 

		this.label_AccessRestrictionRulesManager_IPAddress.Text = ServerStringFactory.GetString(185, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
	
		this.label_AccessRestrictionRulesManager_MACAddress.Text = ServerStringFactory.GetString(186, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
	
		this.label_AccessRestrictionRulesManager_RuleType.Text = ServerStringFactory.GetString(196, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 

		this.checkBox_AccessRestrictionRulesManager_AddMACAdressToRule.Text = ServerStringFactory.GetString(194, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
		...
		this.comboBox_AccessRestrictionRulesManager_RuleType.Items.AddRange(new object[] {
																							 ServerStringFactory.GetString(197, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage),
																							 ServerStringFactory.GetString(198, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage)});
	
		this.groupBox_AccessRestrictionRulesManager_IPRange.Text = ServerStringFactory.GetString(227, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage); 
	}


	public AccessRestrictionRulesManagerForm()
	{
		InitializeComponent();
	...
	{
		System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(AccessRestrictionRulesManagerForm));
	...
	bool VerifySingleIPAddressToCorrectValue()
	{
		...
		{
			MessageBox.Show(ServerStringFactory.GetString(199, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), MessageBoxButtons.OK, MessageBoxIcon.Information);
	...
	bool VerifyIPAddressesRangeStartValueToCorrect()
	{
		...
		{
			MessageBox.Show(ServerStringFactory.GetString(200, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
	...
	bool VerifyIPAddressesRangeEndValueToCorrect()
	{
		...
		{					
			...
			{
				MessageBox.Show(ServerStringFactory.GetString(202, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
		...
		{
			MessageBox.Show(ServerStringFactory.GetString(201, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
	...
	{
		NetworkSecurity.AccessRestrictionRuleObject accessRestrictionRuleObject_obj = null;

		for(int int_CycleCount = 0; int_CycleCount != LocalObjCopy.obj_NetworkSecurity_AccessRestrictionRuleObject.RemotingWrapper_AccessRestrictionRules.Count; int_CycleCount++)
		{
			if(int_MissRecord == int_CycleCount) continue;

			accessRestrictionRuleObject_obj = LocalObjCopy.obj_NetworkSecurity_AccessRestrictionRuleObject.RemotingWrapper_AccessRestrictionRules[int_CycleCount];

			if(accessRestrictionRuleObject_obj.RuleType != this.comboBox_AccessRestrictionRulesManager_RuleType.SelectedIndex)
			{
				MessageBox.Show(ServerStringFactory.GetString(203, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
			...
			this.radioButton_AccessRestrictionRulesManager_RestrictByMACAddress.Checked == true)
		{
			...
			for(int int_CycleCount = 0; int_CycleCount != LocalObjCopy.obj_NetworkSecurity_AccessRestrictionRuleObject.RemotingWrapper_AccessRestrictionRules.Count; int_CycleCount++)
			{
				...
				{
					MessageBox.Show(ServerStringFactory.GetString(204, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
		...
		if(this.radioButton_AccessRestrictionRulesManager_RestrictByIPAddress.Checked == true)
		{
			...
			for(int int_CycleCount = 0; int_CycleCount != LocalObjCopy.obj_NetworkSecurity_AccessRestrictionRuleObject.RemotingWrapper_AccessRestrictionRules.Count; int_CycleCount++)
			{
				...
				{
					MessageBox.Show(ServerStringFactory.GetString(205, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
				...
				{
					MessageBox.Show(ServerStringFactory.GetString(206, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
		...
		if(this.radioButton_AccessRestrictionRulesManager_RestrictByIPRange.Checked == true)
		{
			...
			for(int int_CycleCount = 0; int_CycleCount != LocalObjCopy.obj_NetworkSecurity_AccessRestrictionRuleObject.RemotingWrapper_AccessRestrictionRules.Count; int_CycleCount++)
			{
				...
				{
					MessageBox.Show(ServerStringFactory.GetString(207, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
				...
				{
					MessageBox.Show(ServerStringFactory.GetString(208, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
	...
	{	
        ...
        string string_IPAddressesRangeStartValue = this.textBox_AccessRestrictionRulesManager_IPRangeStartValue.Text;
        string string_IPAddressesRangeEndValue = this.textBox_AccessRestrictionRulesManager_IPRangeEndValue.Text;
        string string_IPAddress = this.textBox_AccessRestrictionRulesManager_IPAddress.Text;
        string string_MACAddress = MACAddress;
        bool bool_ComplementaryUseMACAddress = this.checkBox_AccessRestrictionRulesManager_AddMACAdressToRule.Checked;

        LocalObjCopy.obj_NetworkSecurity.RemotingWrapper_EditExistingAccessRestrictionRuleInDB(string_IPAddressesRangeStartValue, string_IPAddressesRangeEndValue, string_IPAddress, string_MACAddress, bool_ComplementaryUseMACAddress, this.comboBox_AccessRestrictionRulesManager_RuleType.SelectedIndex, EditedRecordIndex);
        
		LocalObjCopy.obj_NetworkSecurity.RemotingWrapper_EditExistingAccessRestrictionRule(iPAddress_IPAddressesRangeStartValue, iPAddress_IPAddressesRangeEndValue, iPAddress_IPAddress, MACAddress, this.checkBox_AccessRestrictionRulesManager_AddMACAdressToRule.Checked,
                                                                dateTime_CreationTime, this.comboBox_AccessRestrictionRulesManager_RuleType.SelectedIndex, EditedRecordIndex);
        
		LocalObjCopy.obj_MainServerForm.EditAccessRestrictionRuleInListView(EditedRecordIndex, string_IPAddressesRangeValue, this.IPAddressTextBox.Text, MACAddress, this.comboBox_AccessRestrictionRulesManager_RuleType.Text);
	}
	...
	void AddNewRule()
	{
        ...
        LocalObjCopy.obj_NetworkSecurity.RemotingWrapper_StoreAccessRestrictionRuleToDB(this.IPRangeStartValueTextBox.Text, this.IPRangeEndValueTextBox.Text, this.IPAddressTextBox.Text, MACAddress, this.checkBox_AccessRestrictionRulesManager_AddMACAdressToRule.Checked, dateTime_CreationTime, this.comboBox_AccessRestrictionRulesManager_RuleType.SelectedIndex, true);

        LocalObjCopy.obj_NetworkSecurity.RemotingWrapper_AddNewAccessRestrictionRule(iPAddress_IPAddressesRangeStartValue, iPAddress_IPAddressesRangeEndValue, iPAddress_IPAddress, MACAddress, this.checkBox_AccessRestrictionRulesManager_AddMACAdressToRule.Checked, dateTime_CreationTime, this.comboBox_AccessRestrictionRulesManager_RuleType.SelectedIndex, true);
