...
public class RegistrationForm : System.Windows.Forms.Form
{
	...
	private void button_Apply_Click(object sender, System.EventArgs e)
	{
		...
		{
			MessageBox.Show(ServerStringFactory.GetString(82, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
			
			return;
		}
        /*
		if(LocalObjCopy.obj_MainServerForm.CheckSN(textBox_Name.Text, textBox_RegistrationNumber.Text) == 1) 
		{
			MessageBox.Show(ServerStringFactory.GetString(83, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
		...
		*/	
		else MessageBox.Show(ServerStringFactory.GetString(84, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage), ServerStringFactory.GetString(1, LocalObjCopy.obj_ServerSettingsEnvironment.RemotingWrapper_CurrentLanguage));
	}
