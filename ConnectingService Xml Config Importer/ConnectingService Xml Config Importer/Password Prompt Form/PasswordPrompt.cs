...
public class PasswordPromptForm : System.Windows.Forms.Form
{
    ...
    public void ChangeControlsLanguage()
    {
        ...
        this.label_PasswordPromptForm_Password.Text = CSStringFactory.GetString(16, CSSettingsEnvironment.CurrentLanguage);

        this.label_PasswordPromptForm_Descpription.Text = CSStringFactory.GetString(151, CSSettingsEnvironment.CurrentLanguage);

        this.button_PasswordPromptForm_Cancel.Text = CSStringFactory.GetString(86, CSSettingsEnvironment.CurrentLanguage);

        this.button_PasswordPromptForm_Accept.Text = CSStringFactory.GetString(119, CSSettingsEnvironment.CurrentLanguage);
    }
