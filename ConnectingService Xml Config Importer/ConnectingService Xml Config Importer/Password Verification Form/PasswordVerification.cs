...
public class PasswordVerificationForm : System.Windows.Forms.Form
{
    ...
    public void ChangeControlsLanguage()
    {
            ...
            this.Text = CSStringFactory.GetString(117, CSSettingsEnvironment.CurrentLanguage);

            this.label_Title.Text = CSStringFactory.GetString(90, CSSettingsEnvironment.CurrentLanguage);

            this.groupBox_Contacts.Text = CSStringFactory.GetString(89, CSSettingsEnvironment.CurrentLanguage);

            this.richTextBox_About.Text = CSStringFactory.GetString(2, CSSettingsEnvironment.CurrentLanguage);

            this.label_PasswordVerivicationForm_Password.Text = CSStringFactory.GetString(16, CSSettingsEnvironment.CurrentLanguage);

            this.groupBox_PasswordVerivicationForm_Language.Text = CSStringFactory.GetString(118, CSSettingsEnvironment.CurrentLanguage);

            this.label_PasswordVerivicationForm_CurrentLanguage.Text = CSStringFactory.GetString(66, CSSettingsEnvironment.CurrentLanguage);

            this.button_PasswordVerivicationForm_Quit.Text = CSStringFactory.GetString(31, CSSettingsEnvironment.CurrentLanguage);

            this.button_PasswordVerivicationForm_Login.Text = CSStringFactory.GetString(119, CSSettingsEnvironment.CurrentLanguage);

            this.button_PasswordVerivicationForm_LoginWithOutPassword.Text = CSStringFactory.GetString(122, CSSettingsEnvironment.CurrentLanguage);

            this.groupBox_PasswordVerivicationForm_WhenPasswordLost.Text = CSStringFactory.GetString(121, CSSettingsEnvironment.CurrentLanguage);

            this.label_PasswordVerivicationForm_LostPasswordDecription.Text = CSStringFactory.GetString(120, CSSettingsEnvironment.CurrentLanguage);
    ...
    {
            if (DialogResult.No == MessageBox.Show(CSStringFactory.GetString(123, CSSettingsEnvironment.CurrentLanguage), CSStringFactory.GetString(1, CSSettingsEnvironment.CurrentLanguage), MessageBoxButtons.YesNo, MessageBoxIcon.Question))
            {
            ...
            try
            {
                ...
                new YakSysConnectingServiceV10XMLConfigImporter().InitMainServerXmlDB();
                new YakSysConnectingServiceV10XMLConfigImporter().InitSMTPSettingsXmlDB();
    ...
    private void comboBox_PasswordVerivicationForm_Language_SelectedIndexChanged(object sender, System.EventArgs e)
    {
            ...
            CSSettingsEnvironment.CurrentLanguage = comboBox_PasswordVerivicationForm_Language.SelectedIndex;
    ...
    private void PasswordVerificationForm_Load(object sender, EventArgs e)
    {
        if (CallerID == 0)
        {
            this.comboBox_PasswordVerivicationForm_Language.SelectedIndex = CSSettingsEnvironment.CurrentLanguage;
        }
        else
        {
            this.comboBox_PasswordVerivicationForm_Language.SelectedIndex = CSSettingsEnvironment.CurrentLanguage;
